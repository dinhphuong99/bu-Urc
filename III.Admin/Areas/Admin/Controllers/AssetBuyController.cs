...
namespace III.Admin.Controllers
{
    ...
    public class AssetBuyController : BaseController
    {
        ...
        public AssetBuyController(EIMDBContext context, IUploadService upload, IHostingEnvironment hostingEnvironment, IStringLocalizer<ContractController> contractController, IStringLocalizer<AssetInventoryController> inventoryController,
            IStringLocalizer<CustomerController> stringLocalizerCus, IStringLocalizer<FileObjectShareController> stringLocalizerFile, IStringLocalizer<AssetBuyController> stringLocalizer, IStringLocalizer<SharedResources> sharedResources)
        {
        ...
        public object JTableAssetBuy([FromBody]JTableModelAsset jTablePara)
        {
            ...
            var query = (from a in _context.AssetBuyHeaders
                         join c in _context.HREmployees on a.Buyer equals c.Id.ToString() into c1
                         from c2 in c1.DefaultIfEmpty()
                         join d in _context.AdGroupUsers on a.Depart equals d.GroupUserCode into d1
        ...
        public JsonResult Insert([FromBody]INSERTModel obj)
        {
            ...
            try
            {
                ...
                if (data == null)
                {
                    ...
                    // msg.Title = String.Format(CommonUtil.ResourceValue("Thêm phiếu mua tài sản thành công")/*, CommonUtil.ResourceValue("DCD_MSG_TITLE_DCD")*/);
                ...
                {
                    msg.Error = true;
                    // msg.Title = String.Format(CommonUtil.ResourceValue("Mã phiếu mua tài sản đã tồn tại"));/*DCD_MSG_DOCUMENT_NOT*/
        ...
        public JsonResult Update([FromBody] INSERTModel obj)
        {
            ...
            try
            {
                ...
                _context.SaveChanges();
                //msg.Title = "Cập nhật phiếu mua tài sản thành công";
        ...
        public object JTableADD([FromBody] JTableModelAsset jTablePara)
        {
            ...
            var query = (from a in _context.AssetBuyDetails
                         join c in _context.AssetMains on a.AssetCode equals c.AssetCode into c1
                         from c2 in c1.DefaultIfEmpty()
                         join f in _context.Suppliers on a.Supplier equals f.SupCode into f1
                         from f2 in f1.DefaultIfEmpty()
            ...
            int count = query.Count();
            var data = query.AsQueryable().OrderUsingSortExpression(jTablePara.QueryOrderBy).Skip(intBegin).Take(jTablePara.Length);
            var jdata = JTableHelper.JObjectTable(data.ToList(), jTablePara.Draw, count, "AssetName", "ID", "Quantity", "StatusAsset", "Note", "AssetType", "CostValue", "Supplier");
            return Json(jdata);
        }

...
namespace III.Admin.Controllers
{
    ...
    public class AssetInventoryController : BaseController
    {
        ...
        public AssetInventoryController(EIMDBContext context, IUploadService upload, IHostingEnvironment hostingEnvironment, IStringLocalizer<ContractController> contractController,
            IStringLocalizer<CustomerController> stringLocalizerCus, IStringLocalizer<FileObjectShareController> stringLocalizerFile, IStringLocalizer<AssetInventoryController> stringLocalizer, IStringLocalizer<SharedResources> sharedResources)
        {
        ...
        public JsonResult Insert([FromBody]AssetInventoryHeadersJtableModel obj)
        {
            ...
            try
            {
                ...
                if (data == null)
                {
                    ...
                    // Thêm phiếu kiểm kê tài sản thành công!
                    //msg.Title = String.Format(CommonUtil.ResourceValue("COM_MSG_ADD_SUCCESS"), CommonUtil.ResourceValue(_stringLocalizer["ASSET_INVENTORY_TICKET"])); 
                ...
                else
                {
                    ...
                    //msg.Title = String.Format(CommonUtil.ResourceValue("COM_MSG_EXITS"), CommonUtil.ResourceValue(_stringLocalizer["ASSET_INVENTORY_TICKET"]));
        ...
        public JsonResult Update([FromBody]AssetInventoryHeadersJtableModel obj)
        {
            ...
            try
            {
                ...
                _context.SaveChanges();
                //msg.Title = "Cập nhật phiếu kiểm kê thành công";
                //msg.Title = String.Format(CommonUtil.ResourceValue("COM_MSG_UPDATE_SUCCESS"), CommonUtil.ResourceValue(_stringLocalizer["ASSET_INVENTORY_TICKET"]));
        ...
        public JsonResult Delete(int Id)
        {
            ...
            try
            {
                ...
                InsertLogDataAuto(actCode, data);
                _context.SaveChanges();
                //msg.Title = "Xóa phiếu kiểm kê thành công!";
                //msg.Title = String.Format(CommonUtil.ResourceValue("COM_MSG_DELETE_SUCCESS"), CommonUtil.ResourceValue(_stringLocalizer["ASSET_INVENTORY_TICKET"]));
            ...
            try
            {
                ...
                else
                {
                    ...
                    if (data == null)
                    {
                        ...
                        //msg.Title = String.Format(CommonUtil.ResourceValue("COM_MSG_ADD_SUCCESS"), CommonUtil.ResourceValue(_stringLocalizer["ASSET_INVENTORY_ASSET"]));
        ...
        public JsonResult DeleteAsset(int Id)
        {
            ...
            try
            {
                ...
                //msg.Title = String.Format(CommonUtil.ResourceValue("COM_MSG_DELETE_SUCCESS"), CommonUtil.ResourceValue(_stringLocalizer["ASSET_INVENTORY_ASSET"]));
        ...
        public JsonResult UploadFile(AssetRqFile obj, IFormFile fileUpload)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    _context.SaveChanges();
                    //msg.Title = String.Format(CommonUtil.ResourceValue("COM_MSG_ADD_SUCCESS"), CommonUtil.ResourceValue(_stringLocalizer["ASSET_INVENTORY_FILE"]));
            ...
            {
                //msg.Title = String.Format(CommonUtil.ResourceValue("COM_MSG_ADD_FAILED"), CommonUtil.ResourceValue(_stringLocalizer["ASSET_INVENTORY_FILE"]));
                msg.Title = _sharedResources["COM_MSG_ERR"];
        ...
        public object InsertLogData([FromBody]ActivityLogDataRes obj)
        {
            ...
            try
            {
                ...
                if (obj.ObjActCode != null && obj.ObjCode != null)
                {
                    ...
                    //msg.Title = String.Format(CommonUtil.ResourceValue("COM_MSG_ADD_SUCCESS"), CommonUtil.ResourceValue(_stringLocalizer["ASSET_INVENTORY_ACT"]));
            ...
            try
            {
                ...
                if (checkStatus == null)
                {
                    ...
                    if (check == null && obj.WorkFlowCode != null && obj.ObjCode != null && obj.ActCode != null)
                    {
                        ...
                        //msg.Title = String.Format(CommonUtil.ResourceValue("COM_MSG_ADD_SUCCESS"), CommonUtil.ResourceValue(_stringLocalizer["ASSET_INVENTORY_ATTR"]));
                    ...
                    else
                    {
                        ...
                        msg.Title = string.Format(_sharedResources["COM_MSG_EXITS"], _stringLocalizer["ASSET_INVENTORY_ATTR"]);
                    }
                }
                else
                {

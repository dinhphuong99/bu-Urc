...
namespace III.Admin.Controllers
{
    ...
    public class UrencoAssetsCategoryController : BaseController
    {
        ...
        private readonly IStringLocalizer<UrencoAssetsCategoryController> _stringLocalizer;
        private readonly IStringLocalizer<SharedResources> _sharedResources;
        public UrencoAssetsCategoryController(EIMDBContext context, IStringLocalizer<UrencoAssetsCategoryController> stringLocalizer, IStringLocalizer<SharedResources> sharedResources)
        {
            _context = context;

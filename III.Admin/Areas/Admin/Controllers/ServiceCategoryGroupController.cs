...
namespace III.Admin.Controllers
{
    ...
    public class ServiceCategoryGroupController : BaseController
    {
        ...
        public ServiceCategoryGroupController(EIMDBContext context, IOptions<AppSettings> appSettings, IStringLocalizer<ServiceCategoryGroupController> stringLocalizer, IStringLocalizer<SharedResources> sharedResources)
        {
            _context = context;
        ...
        {
            ViewData["Title"] = _stringLocalizer["SCG_TITLE_PAGE"];
            return View();
        }
        [HttpPost]

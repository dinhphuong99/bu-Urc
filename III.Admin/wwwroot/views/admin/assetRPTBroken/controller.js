...
var app = angular.module('App_ESEIM_RPT', ["ui.bootstrap", "ngRoute", "ngValidate", "datatables", "datatables.bootstrap", 'datatables.colvis', "ui.bootstrap.contextMenu", 'datatables.colreorder', 'angular-confirm', "ngJsTree", "treeGrid", "ui.select", "ngCookies", "pascalprecht.translate", 'dynamicNumber', 'monospaced.qrcode', 'ngTagsInput']).
...
app.controller('index', function ($scope, $rootScope, $compile, $uibModal, DTOptionsBuilder, DTColumnBuilder, DTInstances, dataserviceRPT, $filter) {
    $scope.modelsearch = {
        TicketCode: "",
        Ticket: "",
        FromDate: "",
...
app.controller('ticketRPT', function ($scope, $rootScope, $confirm, $compile, $uibModal, DTOptionsBuilder, DTColumnBuilder, DTInstances, dataserviceRPT, $filter, $translate) {
    var vm = $scope;
...
app.controller('add', function ($scope, $rootScope, $compile, $uibModal, $uibModalInstance, DTColumnBuilder, DTInstances, dataserviceRPT, $filter) {
    $scope.CheckCode = '';
    $scope.model = {
        AssetStatus: $rootScope.listAssetStatus.length > 0 ? $rootScope.listAssetStatus[0].Code : '',
        Person: '',
        Branch: ''
    }
...
app.controller('editRPT', function ($scope, $rootScope, $compile, $uibModal, $uibModalInstance, DTColumnBuilder, DTInstances, dataserviceRPT, $filter, para) {
        ...
        if ($scope.editform.validate() && !validationSelect($scope.model).Status) {
            ...
            dataserviceRPT.updateRPT($scope.model, function (rs) {
                ...
                if (rs.Error) {
                    ...
                    App.toastrSuccess(rs.Title);
                    $rootScope.reloadHeader();// load db ra bảng luôn
                    $uibModalInstance.close();
    ...
    $scope.changleSelect = function (SelectType) {
        ...
        if (SelectType == "ActCode" && $scope.model.ActCode != "") {
            ...
            dataserviceRPT.insertLogData($scope.model, function (result) {
                result = result.data;
                if (result.Error) {
                    App.toastrError(result.Title);
                } else {
...
app.controller('fileAsset', function ($scope, $rootScope, $compile, $uibModal, DTOptionsBuilder, DTColumnBuilder, DTInstances, dataserviceRPT, $filter) {
    var vm = $scope;
    $scope.selected = [];
    $scope.selectAll = false;
    $scope.toggleAll = toggleAll;

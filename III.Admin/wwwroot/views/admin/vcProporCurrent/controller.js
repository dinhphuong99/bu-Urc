var ctxfolder = "/views/admin/vcProporCurrent";
...
app.factory('dataservice', function ($http) {
    ...
    return {
        ...
        //    $http.post('/Admin/VCProporCurrent/Insert', data, callback).success(callback);
        //},
        //update: function (data, callback) {
        //    $http.post('/Admin/VCProporCurrent/Update', data).success(callback);
        //},
        //deleteItems: function (data, callback) {
        //    $http.post('/Admin/VCProporCurrent/DeleteItems', data).success(callback);
        //},
        //delete: function (data, callback) {
        //    $http.post('/Admin/VCProporCurrent/Delete/' + data).success(callback);
        //},
        //getItem: function (data, callback) {
        //    $http.get('/Admin/VCProporCurrent/GetItem/' + data).success(callback);
        //},
        //getItemDetail: function (data, callback) {
        //    $http.get('/Admin/VCProporCurrent/GetItemDetail/' + data).success(callback);
        //},
        getListArea: function (callback) {
            $http.post('/Admin/VCProporCurrent/GetListArea/').success(callback);
        },
        getAllStaff: function (callback) {
            $http.post('/Admin/VCProporCurrent/GetAllStaff/').success(callback);
        },
        getListCustomer: function (callback) {
            $http.post('/Admin/VCProporCurrent/GetListCustomer/').success(callback);
        },
        //gettreedataLevel: function (callback) {
        //    $http.post('/Admin/VCProporCurrent/GetProductUnit/').success(callback);
        //},
        //uploadImage: function (data, callback) {
        //    submitFormUpload('/Admin/VCProporCurrent/UploadImage/', data, callback);
        //}
    }
});
...
app.controller('index', function ($scope, $rootScope, $confirm, $compile, $uibModal, DTOptionsBuilder, DTColumnBuilder, DTInstances, dataservice, $http, $filter) {
    ...
    vm.dtOptions = DTOptionsBuilder.newOptions()
        .withOption('ajax', {
            url: "/Admin/VCProporCurrent/Jtable",
    ...
    vm.dtColumns.push(DTColumnBuilder.newColumn('Proportion').withTitle('{{ "VCMM_LIST_COL_PROPORTION_ENTER_HAND" | translate }}').notSortable().withOption('sClass', 'tcenter').renderWith(function (data, type) {
        if (data == "") {
            return "";
        } else {
            if (data >= 50) {
    ...
    vm.dtColumns.push(DTColumnBuilder.newColumn('ProportionCal').withTitle('{{ "VCMM_LIST_COL_PROPORTION_CALTULATE" | translate }}').notSortable().withOption('sClass', 'tcenter').renderWith(function (data, type) {
        if (data == "") {
            return "";
        } else {
    ...
    //vm.dtColumns.push(DTColumnBuilder.newColumn('Instock').withTitle('Tồn kho Bút Sơn (T)').notSortable().withOption('sClass', 'tcenter').renderWith(function (data, type) {
    //    if (data == "") {
    //        return '';
    //    } else {
    //        var dataFormat = $filter('currency')(data, '', 1);
    ...
    //        return '';
    //}));
    //vm.dtColumns.push(DTColumnBuilder.newColumn('Note').withTitle('Ghi chú').notSortable().withOption('sClass', 'tcenter').renderWith(function (data, type) {
    //    return data;
    //}));
    ...
    $scope.export = function () {
        ...
        location.href = "/Admin/VCProporCurrent/ExportExcel?"
            + "page=" + page
            + "&row=" + length

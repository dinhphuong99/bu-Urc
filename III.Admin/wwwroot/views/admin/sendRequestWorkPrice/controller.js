...
var app = angular.module('App_ESEIM_PRICE', ['App_ESEIM_CARD_JOB', "ui.bootstrap", "ngRoute", "ngValidate", "datatables", "datatables.bootstrap", 'datatables.colvis', "ui.bootstrap.contextMenu", 'datatables.colreorder', 'angular-confirm', "ngJsTree", "treeGrid", "ui.select", "ngCookies", "pascalprecht.translate", 'dynamicNumber']);
...
app.factory('dataserviceRQPrice', function ($http) {
    ...
    return {
        ...
        getSuggestionsContractFile: function (data, callback) {
            $http.get('/Admin/SendRequestWorkPrice/GetSuggestionsContractFile?contractCode=' + data).then(callback);
        },
...
app.controller('Ctrl_ESEIM_PRICE', function ($scope, $rootScope, $cookies, $translate, dataserviceRQPrice, $filter) {
    ...
    dataserviceRQPrice.getSuppliers(function (rs) {rs=rs.data;
        $rootScope.Suppliers = rs;
    });

    dataserviceRQPrice.getListStatus(function (rs) {rs=rs.data;
        $rootScope.Status = rs;
        var all = {
            Code: '',
            Name: 'Tất cả'
    ...
    dataserviceRQPrice.getCurrency(function (rs) {rs=rs.data;
...
app.controller('index', function ($scope, $rootScope, $compile, $uibModal, DTOptionsBuilder, DTColumnBuilder, DTInstances, dataserviceRQPrice, $window, $filter) {
    ...
    $scope.delete = function (id) {
        var modalInstance = $uibModal.open({
            ...
            controller: function ($scope, $uibModalInstance) {
                ...
                $scope.ok = function () {
                    dataserviceRQPrice.delete(id, function (result) {result=result.data;
                        if (result.Error) {
...
app.controller('addRQPrice', function ($scope, $rootScope, $compile, $uibModal, $uibModalInstance, DTColumnBuilder, DTInstances, dataserviceRQPrice, $filter) {
    $scope.model = {
        ReqCode: '',
        Title: '',
        ExpectedDate: '',
    ...
    function initData() {
        ...
        dataserviceRQPrice.genReqCode(function (result) {result=result.data;
        ...
        if ($scope.forms.addform.validate() && !validationSelect($scope.model).Status) {
            var modalInstance = $uibModal.open({
                ...
                controller: function ($scope, $uibModalInstance, para) {
                    ...
                    $scope.ok = function () {
                        dataserviceRQPrice.insertRQPrice(para, function (result) {result=result.data;
                            if (result.Error) {
                                App.toastrError(result.Title);
                            } else {
    ...
    $scope.viewActivityStatus = function () {
        dataserviceRQPrice.getActivityStatus($rootScope.Id, function (rs) {rs=rs.data;
            if (rs.Error) {
    ...
    $scope.loadFile = function (event) {
        ...
        dataserviceRQPrice.uploadFile(formData, function (result) {result=result.data;
            if (result.Error) {
                App.toastrError(result.Title);
            } else {
                App.toastrSuccess(result.Title);
...
app.controller('editRQPrice', function ($scope, $filter, $rootScope, $compile, $uibModal, $uibModalInstance, dataserviceRQPrice, para) {
    $scope.isTex = false;
    $scope.isShowHeader = true;
    $scope.isShowDetail = false;
    $scope.forms = {};
        ...
        if ($scope.forms.editform.validate() && !validationSelect($scope.model).Status) {
            var modalInstance = $uibModal.open({
                ...
                controller: function ($scope, $uibModalInstance, para) {
                    ...
                    $scope.ok = function () {
                        dataserviceRQPrice.updateRQPrice(para, function (result) {result=result.data;
                            if (result.Error) {
                                App.toastrError(result.Title);
                            } else {
                                App.toastrSuccess(result.Title);
    ...
    $scope.viewActivityStatus = function () {
        dataserviceRQPrice.getActivityStatus($scope.model.Id, function (rs) {rs=rs.data;
            if (rs.Error) {
                App.toastrError(rs.Title);
            } else {
                var modalInstance = $uibModal.open({
    ...
    $scope.openLog = function () {
        dataserviceRQPrice.getUpdateLog($scope.model.ReqCode, function (rs) {rs=rs.data;
            var modalInstance = $uibModal.open({
                animation: true,
...
app.controller('addProduct', function ($scope, $rootScope, $compile, $uibModal, DTOptionsBuilder, DTColumnBuilder, DTInstances, dataserviceRQPrice, $filter) {
    ...
    $scope.add = function () {
        if ($rootScope.ReqCode != '') {
            ...
            if ($scope.forms.addform.validate() && !validationSelect($scope.model).Status) {
                dataserviceRQPrice.insertDetail($scope.model, function (rs) {rs=rs.data;
                    if (rs.Error) {
                        App.toastrError(rs.Title);
                    }
                    else {
    ...
    $scope.initLoad = function () {
        dataserviceRQPrice.getListProduct(function (rs) {rs=rs.data;
            $scope.products = rs;
        });
    }
    ...
    $scope.save = function (id) {
        validationSelect($scope.model);
        if ($scope.forms.addform.validate() && !validationSelect($scope.model).Status) {
            dataserviceRQPrice.updateDetail($scope.model, function (rs) {rs=rs.data;
                if (rs.Error) {
                    App.toastrError(rs.Title);
                }
                else {
    ...
    $scope.delete = function (id) {
        var modalInstance = $uibModal.open({
            ...
            controller: function ($scope, $uibModalInstance) {
                ...
                $scope.ok = function () {
                    dataserviceRQPrice.deleteDetail(id, function (result) {result=result.data;
                        if (result.Error) {
                            App.toastrError(result.Title);
                        } else {
                            App.toastrSuccess(result.Title);
...
app.controller('attributeManager', function ($scope, $rootScope, $compile, $uibModal, DTOptionsBuilder, DTColumnBuilder, DTInstances, $location, $filter, $uibModalInstance, dataserviceRQPrice, $timeout, para) {
    ...
    $scope.add = function () {
        ...
        dataserviceRQPrice.insertContractAttr($scope.model, function (rs) {rs=rs.data;
            if (rs.Error) {
                App.toastrError(rs.Title);
            }
            else {
    ...
    $scope.delete = function (id) {
        var modalInstance = $uibModal.open({
            ...
            controller: function ($scope, $uibModalInstance) {
                $scope.message = caption.COM_MSG_DELETE_CONFIRM_COM;//"Bạn có chắc chắn muốn xóa?";
                $scope.ok = function () {
                    dataserviceRQPrice.deleteContractAttr(id, function (result) {result=result.data;
                        if (result.Error) {
                            App.toastrError(result.Title);
                        } else {
                            App.toastrSuccess(result.Title);
    ...
    $scope.save = function (id) {
        ...
        dataserviceRQPrice.updateContractAttr($scope.model, function (rs) {rs=rs.data;
            if (rs.Error) {
                App.toastrError(rs.Title);
            }
            else {
...
app.controller('detail', function ($scope, $rootScope, $confirm, $compile, $uibModal, $uibModalInstance, DTOptionsBuilder, DTColumnBuilder, DTInstances, dataserviceRQPrice, $filter, para) {
    ...
    $scope.init = function () {
        dataserviceRQPrice.getDataType(function (rs) {rs=rs.data;
    ...
    $scope.add = function () {
        ...
        if ($scope.model.ValueSet == '') {
            ...
            dataserviceRQPrice.insertCommonSetting($scope.model, function (rs) {rs=rs.data;
                if (rs.Error) {
                    App.toastrError(rs.Title);
                }
                else {
    ...
    $scope.edit = function () {
        if ($scope.model.CodeSet == '') {
            ...
            dataserviceRQPrice.updateCommonSetting($scope.model, function (rs) {rs=rs.data;
                if (rs.Error) {
                    App.toastrError(rs.Title);
                }
                else {
    ...
    $scope.delete = function (id) {
        var modalInstance = $uibModal.open({
            ...
            controller: function ($scope, $uibModalInstance) {
                ...
                $scope.ok = function () {
                    dataserviceRQPrice.deleteCommonSetting(id, function (rs) {rs=rs.data;
                        if (rs.Error) {
                            App.toastrError(rs.Title);
                        } else {
                            App.toastrSuccess(rs.Title);
...
app.controller('tabFile', function ($scope, $rootScope, $compile, $uibModal, DTOptionsBuilder, DTColumnBuilder, DTInstances, dataserviceRQPrice, $filter) {
    var vm = $scope;
    $scope.selected = [];
    $scope.selectAll = false;
    $scope.toggleAll = toggleAll;
    ...
    $scope.extend = function (id) {
        dataserviceRQPrice.getSuggestionsContractFile($rootScope.RequestCode, function (rs) {
            rs = rs.data;
            var data = rs != '' ? rs : {};
            var modalInstance = $uibModal.open({

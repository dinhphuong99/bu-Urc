var ctxfolder = "/views/admin/edmsTermites";
...
app.factory('dataservice', function ($http) {
    ...
    return {
        insert: function (data, callback) {
            $http.post('/Admin/EDMSTermites/Insert', data, callback).success(callback);
        },
        update: function (data, callback) {
            $http.post('/Admin/EDMSTermites/Update', data).success(callback);
        },
        delete: function (data, callback) {
            $http.post('/Admin/EDMSTermites/Delete/' + data).success(callback);
        },
        getItem: function (data, callback) {
            $http.post('/Admin/EDMSTermites/GetItem/' + data).success(callback);
        },
        getItemDetail: function (data, callback) {
            $http.post('/Admin/EDMSTermites/GetItemDetail/' + data).success(callback);
        },
        getItemAdd: function (data, callback) {
            $http.post('/Admin/EDMSTermites/GetItemAdd?Code=' + data).success(callback);
        },
        getListPersonProcessor: function (callback) {
            $http.post('/Admin/EDMSTermites/GetListPersonProcessor/').success(callback);
        },
        getListStatus: function (callback) {
            $http.post('/Admin/EDMSTermites/GetListStatus/').success(callback);
        },
        uploadImage: function (data, callback) {
            submitFormUpload('/Admin/EDMSTermites/UploadImage/', data, callback);
        },

        //Tab Box
        insertTabBox: function (data, callback) {
            $http.post('/Admin/EDMSTermites/InsertTabBox', data, callback).success(callback);
        },
        updateTabBox: function (data, callback) {
            $http.post('/Admin/EDMSTermites/UpdateTabBox', data).success(callback);
        },
        deleteTabBox: function (data, callback) {
            $http.post('/Admin/EDMSTermites/DeleteTabBox/' + data).success(callback);
        },
        getTabBox: function (data, callback) {
            $http.post('/Admin/EDMSTermites/GetTabBox/' + data).success(callback);
        },
        //getListWHS_Code: function (callback) {
        //    $http.post('/Admin/EDMSTermites/GetListWHS_Code/').success(callback);
        //},
        //getListFloorCode: function (data, callback) {
        //    $http.post('/Admin/EDMSTermites/GetListFloorCode?WHS_Code=' + data).success(callback);
        //},
        //getListLineCode: function (data2, callback) {
        //    $http.post('/Admin/EDMSTermites/GetListLineCode?FloorCode=' + data2).success(callback);
        //},
        //getListRackCode: function (data3, callback) {
        //    $http.post('/Admin/EDMSTermites/GetListRackCode?LineCode=' + data3).success(callback);
        //},
        //getListBoxId: function (data4, callback) {
        //    $http.post('/Admin/EDMSTermites/GetListBoxId?RackCode=' + data4).success(callback);
        //},
        getListBoxId: function (callback) {
            $http.post('/Admin/EDMSTermites/GetListBoxId/').success(callback);
        },
        ...
        generatorQRCode: function (data, callback) {
            $http.post('/Admin/EDMSTermites/GeneratorQRCode?code=' + data).success(callback);
        },
    };
});
...
app.controller('Ctrl_ESEIM', function ($scope, $rootScope, $compile, $cookies, $translate, dataservice) {
        ...
        $rootScope.validationOptions = {
            ...
            messages: {
                Name: {
                    ...
                    required: (caption.EDMSTER_VALIDATE_TITLE),
                    maxlength: "Tiêu đề không vượt quá 255 kí tự!"
                },
                FromDate: {
                    //required: "Nhập ngày bắt đầu!",
                    required: (caption.EDMSTER_VALIDATE_FROM_DATE),
                    //maxlength: "Tiêu đề không vượt quá 255 kí tự!"
                },
                ToDate: {
                    //required: "Nhập ngày kết thúc!",
                    required: (caption.EDMSTER_VALIDATE_TO_DATE),
                    //maxlength: "Hành động không vượt quá 255 kí tự!"
                },
                Business: {
                    //required: "Nhập nghiệp vụ!",
                    required: (caption.EDMSTER_VALIDATE_MAJOR),
    ...
    if (isCmTermite) {
        $rootScope.isCmTermite = true;
    }
    if (isBoxTermite) {
        $rootScope.isBoxTermite = true;
    }
});
...
app.controller('cmTermite', function ($scope, $rootScope, $compile, $uibModal, DTOptionsBuilder, DTColumnBuilder, DTInstances, dataservice, $filter) {
    var vm = $scope;
    $scope.model = {
        Name: '',
        Business: '',
    ...
    vm.dtOptions = DTOptionsBuilder.newOptions()
        .withOption('ajax', {
            url: "/Admin/EDMSTermites/JTableCmTermite",
            ...
            $(row).find('td:not(:has(label.mt-checkbox))').on('click', function (evt) {
                if (evt.target.localName == 'input' && evt.target.type == 'checkbox') {
                    ...
                    if ($(self).hasClass('selected')) {
                        ...
                        $('#tblDataCmTermite').DataTable().$('tr.selected').removeClass('selected');
    ...
    vm.dtColumns.push(DTColumnBuilder.newColumn('Code').withTitle('{{"EDMSTER_TAB_CM_TERMITE_COL_CODE" | translate}}').renderWith(function (data, type) {
        return data;
    }));
    vm.dtColumns.push(DTColumnBuilder.newColumn('Name').withTitle('{{"EDMSTER_TAB_CM_TERMITE_COL_NAME" | translate}}').renderWith(function (data, type) {
        return data;
    }));
    vm.dtColumns.push(DTColumnBuilder.newColumn('FromDate').withTitle('{{"EDMSTER_TAB_CM_TERMITE_COL_FROMDATE" | translate}}').renderWith(function (data, type) {
        return data;
    }));
    vm.dtColumns.push(DTColumnBuilder.newColumn('ToDate').withTitle('{{"EDMSTER_TAB_CM_TERMITE_COL_TODATE" | translate}}').renderWith(function (data, type) {
        return data;
    }));
    vm.dtColumns.push(DTColumnBuilder.newColumn('Business').withTitle('{{"EDMSTER_TAB_CM_TERMITE_COL_BUSINESS" | translate}}').renderWith(function (data, type) {
        return data;
    }));
    vm.dtColumns.push(DTColumnBuilder.newColumn('action').withTitle('{{"EDMSTER_TAB_CM_TERMITE_COL_ACTION" | translate}}').renderWith(function (data, type, full) {
        return '<a title="Danh sách người xử lý" ng-click="view(' + full.Id + ')">Chi tiết</a>'
    }));
    vm.dtColumns.push(DTColumnBuilder.newColumn('Picture').withTitle('{{"EDMSTER_TAB_CM_TERMITE_COL_PICTURE" | translate}}').notSortable().renderWith(function (data, type, full) {
        return '<img class="img-circle" src="' + data + '" onerror =' + "'" + 'this.src="' + '/images/default/no_image.png' + '"' + "'" + 'height="65" width="65">';
    }));
    vm.dtColumns.push(DTColumnBuilder.newColumn('Note').withTitle('{{"EDMSTER_TAB_CM_TERMITE_COL_NOTE" | translate}}').notSortable().renderWith(function (data, type, full) {
        return data;
    }));
    vm.dtColumns.push(DTColumnBuilder.newColumn('StatusName').withTitle('{{"EDMSTER_TAB_CM_TERMITE_COL_STATUS_NAME" | translate}}').notSortable().renderWith(function (data, type, full) {
        return data;
    }));
    vm.dtColumns.push(DTColumnBuilder.newColumn('action').notSortable().withOption('sClass', 'nowrap').withTitle('{{"EDMSTER_TAB_CM_TERMITE_COL_" | translate}}').withOption('sClass', '').renderWith(function (data, type, full, meta) {
...
app.controller('boxTermite', function ($scope, $rootScope, $compile, $uibModal, DTOptionsBuilder, DTColumnBuilder, DTInstances, dataservice, $filter) {
    var vm = $scope;
    $scope.model = {
        Text: '',
        PersonProcessor: '',
        Status: 'TERMITE_PENDING',
        FromDate: '',
        ToDate: '',
    };
    $scope.selected = [];
    ...
    vm.dtOptions = DTOptionsBuilder.newOptions()
        .withOption('ajax', {
            url: "/Admin/EDMSTermites/JTableBoxTermite",
            beforeSend: function (jqXHR, settings) {
                App.blockUI({
                    target: "#contentMain",
                    boxed: true,
    ...
    vm.dtColumns.push(DTColumnBuilder.newColumn('BoxCode').withTitle('{{"EDMSTER_TAB_BOX_TERMITE_COL_BOX_CODE" | translate}}').renderWith(function (data, type) {
    ...
    vm.dtColumns.push(DTColumnBuilder.newColumn('NumBoxth').withTitle('{{"EDMSTER_TAB_BOX_TERMITE_COL_NUMBOXTH" | translate}}').withOption('sClass', 'tcenter').renderWith(function (data, type) {
        return data;
    }));
    vm.dtColumns.push(DTColumnBuilder.newColumn('WHS_Name').withTitle('{{"EDMSTER_TAB_BOX_TERMITE_COL_WHS_NAME" | translate}}').renderWith(function (data, type) {
        return data;
    }));
    vm.dtColumns.push(DTColumnBuilder.newColumn('Placement').withTitle('{{"EDMSTER_TAB_BOX_TERMITE_COL_PLACEMENT" | translate}}').renderWith(function (data, type, full) {
        return data;
    }));
    ...
    //    return data;
    //}));
    vm.dtColumns.push(DTColumnBuilder.newColumn('FromDate').withTitle('{{"EDMSTER_TAB_BOX_TERMITE_COL_FROMDATE"| translate}}').renderWith(function (data, type) {
        return data;
    }));
    vm.dtColumns.push(DTColumnBuilder.newColumn('ToDate').withTitle('{{"EDMSTER_TAB_BOX_TERMITE_COL_TODATE"| translate}}').renderWith(function (data, type) {
        return data;
    }));
    vm.dtColumns.push(DTColumnBuilder.newColumn('action').withTitle('{{"EDMSTER_TAB_BOX_TERMITE_COL_ACTION"| translate}}').withOption('sClass', 'tcenter').renderWith(function (data, type, full) {
        return '<a title="Danh sách người xử lý" ng-click="view(' + full.Id + ')">Chi tiết</a>'
    }));
    vm.dtColumns.push(DTColumnBuilder.newColumn('StatusName').withTitle('{{"EDMSTER_TAB_BOX_TERMITE_COL_STATUS_NAME"| translate}}').notSortable().renderWith(function (data, type, full) {
        return data;
    }));
    vm.reloadData = reloadData;
    vm.dtInstance = {};
    ...
    $scope.initLoad();
    $rootScope.reloadBoxTermite = function () {
        $scope.reload();
    }
    $scope.reload = function () {
        reloadData(true);
    ...
    function loadDate() {
        $("#FromToBoxTermite").datepicker({
            ...
            var maxDate = new Date(selected.date.valueOf());
            $('#DateToBoxTermite').datepicker('setStartDate', maxDate);
        });
        $("#DateToBoxTermite").datepicker({
            inline: false,
            autoclose: true,
            format: "dd/mm/yyyy",
            fontAwesome: true,
            ...
            var maxDate = new Date(selected.date.valueOf());
            $('#FromToBoxTermite').datepicker('setEndDate', maxDate);
        });
        $('.end-date').click(function () {
            var from = $scope.model.FromDate.split("/");
            var date = new Date(from[2], from[1] - 1, from[0])
...
app.controller('add', function ($scope, $rootScope, $compile, $uibModal, $uibModalInstance, DTColumnBuilder, DTInstances, dataservice, $filter) {
    ...
    //$scope.model = {
    //    Id: null,
    //    Code: 'CM_Termite_2019_03_18_14_17_23',
    //    Name: '',
    //    FromDate: '',
    //    ToDate: '',
    //    Business: '',
    ...
    $scope.model.Code = 'CM_Termite_' + d.getFullYear() + '_' + mm + '_' + dd + '_' + hh + '_' + mmi + '_' + d.getSeconds();
                                            ...
                                            if ($rootScope.Id == '') {
                                                dataservice.insert($scope.model, function (rs) {
                                                    ...
                                                    if (rs.Error) {
                                                        ...
                                                        $scope.initData = function () {
                                                            dataservice.getItemAdd($rootScope.Code, function (rs) {
                                                                if (rs.Error) {
                                                                    App.toastrError(rs.Title);
                                                                } else {
...
app.controller('tabBox', function ($scope, $rootScope, $compile, $uibModal, DTOptionsBuilder, DTColumnBuilder, DTInstances, dataservice, $filter, $confirm) {
    ...
    vm.dtOptions = DTOptionsBuilder.newOptions()
        .withOption('ajax', {
            url: "/Admin/EDMSTermites/JTableTabBox",
            beforeSend: function (jqXHR, settings) {
                App.blockUI({
                    target: "#contentMain",
                    boxed: true,
    ...
    vm.dtColumns.push(DTColumnBuilder.newColumn('WHS_Name').withTitle('{{"EDMSTER_CURD_TAB_DETAIL_COL_WHS_NAME" | translate}}').renderWith(function (data, type) {
        return data;
    }));
    ...
    //}));
    vm.dtColumns.push(DTColumnBuilder.newColumn('FloorName').withTitle('{{"EDMSTER_CURD_TAB_DETAIL_COL_FLOOR_NAME" | translate}}').withOption('sClass', 'tcenter').renderWith(function (data, type, full) {
        return data;
    }));
    vm.dtColumns.push(DTColumnBuilder.newColumn('L_Text').withTitle('{{"EDMSTER_CURD_TAB_DETAIL_COL_L_TEXT" | translate}}').withOption('sClass', 'tcenter').renderWith(function (data, type) {
        return data;
    }));
    vm.dtColumns.push(DTColumnBuilder.newColumn('RackName').withTitle('{{"EDMSTER_CURD_TAB_DETAIL_COL_RACKNAME" | translate}}').withOption('sClass', 'tcenter').renderWith(function (data, type) {
        return data;
    }));
    vm.dtColumns.push(DTColumnBuilder.newColumn('NumBoxth').withTitle('{{"EDMSTER_CURD_TAB_DETAIL_COL_NUMBOXTH" | translate}}').withOption('sClass', 'tcenter').renderWith(function (data, type) {
        return data;
    }));
    //vm.dtColumns.push(DTColumnBuilder.newColumn('Note').withTitle('{{"Ghi chú" | translate}}').renderWith(function (data, type) {
    //    return data;
    //}));
    vm.dtColumns.push(DTColumnBuilder.newColumn('action').withTitle('{{"EDMSTER_CURD_TAB_DETAIL_COL_ACTION" | translate}}').withOption('sClass', 'tcenter').renderWith(function (data, type, full) {
    ...
    $scope.add = function () {
        ...
        if (validationSelect($scope.model).Status == false) {
            debugger
            $scope.model.TermiteId = $rootScope.Id;

...
var app = angular.module('App_ESEIM_ALLOCATION', ["ui.bootstrap", "ngRoute", "ngValidate", "datatables", "datatables.bootstrap", 'datatables.colvis', "ui.bootstrap.contextMenu", 'datatables.colreorder', 'angular-confirm', "ngJsTree", "treeGrid", "ui.select", "ngCookies", "pascalprecht.translate", 'dynamicNumber', 'monospaced.qrcode', 'ngTagsInput']).
...
app.factory('dataserviceAllocation', function ($http) {
    ...
    return {
        ...
        updateAssetFile: function (data, callback) {
            submitFormUpload('/Admin/AssetAllocation/UpdateAssetFile/', data, callback);
        },
...
app.controller('Ctrl_ESEIM_ALLOCATION', function ($scope, $rootScope, $compile, $uibModal, dataserviceAllocation, $cookies, $translate) {
    ...
    //dataserviceAllocation.getUser(function (rs) {rs=rs.data;
...
app.controller('index', function ($scope, $rootScope, $compile, $uibModal, DTOptionsBuilder, DTColumnBuilder, DTInstances, dataserviceAllocation, $filter) {
    $scope.modelsearch = {
        TicketCode: '',
        Title: '',
        DepartmentSend: '',
...
app.controller('add', function ($scope, $rootScope, $compile, $uibModal, $uibModalInstance, DTColumnBuilder, DTInstances, dataserviceAllocation, $filter) {
    $scope.model = {
        Title: '',
        DepartmentSend: '',
        UserAllocate: '',
...
app.controller('editAllocate', function ($scope, $rootScope, $compile, $uibModal, $uibModalInstance, DTColumnBuilder, DTInstances, dataserviceAllocation, $filter, para) {
    ...
    $scope.pending = function () {
        dataserviceAllocation.pending($scope.model.ID, function (rs) {
            rs = rs.data;
            if (rs.Error) {
                App.toastrError(rs.Title);
            } else {
    ...
    $scope.approve = function () {
        var modalInstance = $uibModal.open({
            animation: true,
            templateUrl: ctxfolderAllocation + '/reasonReject.html',
        ...
        modalInstance.result.then(function (d) {
            ...
            dataserviceAllocation.approve($scope.model.ID, $scope.model.ReasonStatus, function (rs) {
                rs = rs.data;
                if (rs.Error) {
                    App.toastrError(rs.Title);
                } else {
    ...
    $scope.reject = function () {
        ...
        modalInstance.result.then(function (d) {
            ...
            if ($scope.model.ReasonStatus == null || $scope.model.ReasonStatus == undefined)
                $scope.model.ReasonStatus = '';
            dataserviceAllocation.reject($scope.model.ID, $scope.model.ReasonStatus, function (rs) {
                rs = rs.data;
                if (rs.Error) {
                    App.toastrError(rs.Title);
                } else {
...
app.controller('tabAssetAllocateTicket', function ($scope, $rootScope, $compile, $uibModal, DTOptionsBuilder, DTColumnBuilder, DTInstances, dataserviceAllocation, $filter) {
    var vm = $scope;
    $scope.selected = [];
...
app.controller('fileAsset', function ($scope, $rootScope, $compile, $uibModal, DTOptionsBuilder, DTColumnBuilder, DTInstances, dataserviceAllocation, $filter) {
    var vm = $scope;
    $scope.selected = [];
    $scope.selectAll = false;
    $scope.toggleAll = toggleAll;
...
app.controller('tabFileHistory', function ($scope, $rootScope, $compile, $uibModal, $uibModalInstance, DTOptionsBuilder, DTColumnBuilder, DTInstances, dataserviceAllocation, $filter, para) {
    ...
    $scope.getObjectFile = function (id) {
        dataserviceAllocation.getItemFile(id);
    };

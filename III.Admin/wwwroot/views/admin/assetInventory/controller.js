...
var app = angular.module('App_ESEIM_INVENTORY', ["ui.bootstrap", "ngRoute", "ngValidate", "datatables", "datatables.bootstrap", 'datatables.colvis', "ui.bootstrap.contextMenu", 'datatables.colreorder', 'angular-confirm', "ngJsTree", "treeGrid", "ui.select", "ngCookies", "pascalprecht.translate", 'dynamicNumber', 'ngTagsInput']).
...
app.controller('Ctrl_ESEIM_INVENTORY', function ($scope, $rootScope, $compile, $uibModal, dataserviceInventory, $cookies, $translate) {
    ...
    dataserviceInventory.GetStatus(function (result) {result=result.data;
...
app.controller('AssetInventory', function ($scope, $rootScope, $confirm, $compile, $uibModal, DTOptionsBuilder, DTColumnBuilder, DTInstances, dataserviceInventory, $filter, $translate) {
    var vm = $scope;
    ...
    vm.dtColumns.push(DTColumnBuilder.newColumn('Status').withTitle('{{ "ASSET_INVENTORY_TICKET_STATUS" | translate }}').renderWith(function (data, type) {
        return data;
    }));
    ...
    $scope.delete = function (id) {
        var modalInstance = $uibModal.open({
            ...
            controller: function ($scope, $uibModalInstance) {
                ...
                $scope.ok = function () {
                    dataserviceInventory.Delete(id, function (rs) {rs=rs.data;
                        if (rs.Error) {
   ...
   // $scope.model.
    ...
    $scope.addasset = function () {
        ...
        if ($scope.addassetform.validate() && !validationSelect($scope.modelasset).Status) {
            ...
            dataserviceInventory.insertasset($scope.modelasset, function (result) {result=result.data;
                if (result.Error) {
    ...
    $scope.initLoad = function () {
        dataserviceInventory.GetStatusAsset(function (result) {result=result.data;
            $scope.ListStatusAsset = result;
        });
        dataserviceInventory.GetAssset(function (result) {result=result.data;
    ...
    $scope.delete = function (id) {
        var modalInstance = $uibModal.open({
            ...
            controller: function ($scope, $uibModalInstance) {
                $scope.message = caption.COM_MSG_DELETE_CONFIRM.replace('{0}', "");
                $scope.ok = function () {
                    dataserviceInventory.DeleteAsset(id, function (rs) {rs=rs.data;
                        if (rs.Error) {
                            App.toastrError(rs.Title);
                        } else {
                            App.toastrSuccess(rs.Title);
...
app.controller('index', function ($scope, $rootScope, $compile, $uibModal, DTOptionsBuilder, DTColumnBuilder, DTInstances, dataserviceInventory, $filter) {
    $scope.modelsearch = {
        Title: '',
        Person: '',
        Branch: '',
    ...
    $scope.initLoad = function () {
        ...
        dataserviceInventory.GetBranch(function (result) {result=result.data;
        ...
        dataserviceInventory.GetPerson(function (result) {result=result.data;
...
app.controller('add', function ($scope, $rootScope, $compile, $uibModal, $uibModalInstance, DTColumnBuilder, DTInstances, dataserviceInventory, $filter) {
    $scope.model = {
    ...
    dataserviceInventory.getCatObjActivity(function (rs) {rs=rs.data;
    ...
    $scope.submit = function () {
        ...
        if ($scope.addform.validate() && !validationSelect($scope.model).Status) {
            ...
            if (!$rootScope.IsAdd) {
                dataserviceInventory.insert($scope.model, function (result) {result=result.data;
                    if (result.Error) {
                        App.toastrError(result.Title);
                    } else {
                        App.toastrSuccess(result.Title);
                ...
                dataserviceInventory.updateInventory($scope.model, function (rs) {rs=rs.data;
                    if (rs.Error) {
                        App.toastrError(rs.Title);
                    } else {
                        App.toastrSuccess(rs.Title);
    ...
    $scope.addFile = function () {
        if ($rootScope.IsAdd == true) {
            ...
            modalInstance.result.then(function (d) {
                dataserviceInventory.GetListFile($rootScope.TicketCode, function (rs) {rs=rs.data;
    ...
    $scope.deleteFile = function (id) {
        dataserviceInventory.DeleteFile(id, function (result) {result=result.data;
            if (result.Error) {
                App.toastrError(result.Title);
            } else {
                App.toastrSuccess(result.Title);
                dataserviceInventory.GetListFile($scope.model.TicketCode, function (rs) {rs=rs.data;
                    $scope.model.listFile = rs;
                });
            }
        });
    ...
    dataserviceInventory.GetGenReqCode(function (rs) {rs=rs.data;
        if (!rs.Error) {
    ...
    $scope.changleSelect = function (SelectType) {
        ...
        if (SelectType == "ActCode" && $scope.model.ActCode != "") {
            ...
            dataserviceInventory.insertLogData($scope.model, function (result) {result=result.data;
                if (result.Error) {
                    App.toastrError(result.Title);
                } else {
                    App.toastrSuccess(result.Title);
...
app.controller('editInventory', function ($scope, $rootScope, $compile, $uibModal, $uibModalInstance, dataserviceInventory, $filter, para) {
    ...
    $scope.initData = function () {
        dataserviceInventory.getItemInventory(para, function (rs) {
            ...
            //dataserviceInventory.getCatActivity(function (rs) {rs=rs.data;
           ...
           // $scope.model.CancelTime = convertDatetime($scope.model.CancelTime);
            ...
            dataserviceInventory.updateInventory($scope.model, function (rs) {rs=rs.data;
                if (rs.Error) {
                    ...
                    App.toastrSuccess(rs.Title);
                    $scope.reloadNoResetPage1(); // load db ra bảng luôn
                    $uibModalInstance.close();
                    $rootScope.TicketCode = null;
                }
            });
    ...
    $scope.pending = function () {
        dataserviceInventory.getpending($scope.model.AssetID, function (rs) {rs=rs.data;
            if (rs.Error) {
                App.toastrError(rs.Title);
            } else {
    ...
    $scope.reject = function () {
        var modalInstance = $uibModal.open({
            animation: true,
            templateUrl: ctxfolderInventory + '/reasonReject.html',
        ...
        modalInstance.result.then(function (d) {
            ...
            dataserviceInventory.getreject($scope.model.AssetID, $scope.model.ReasonStatus, function (rs) {rs=rs.data;
                if (rs.Error) {
                    App.toastrError(rs.Title);
                } else {
    ...
    $scope.approve = function () {
        ...
        modalInstance.result.then(function (d) {
            ...
            if ($scope.model.ReasonStatus == null || $scope.model.ReasonStatus == undefined)
                $scope.model.ReasonStatus = '';
            dataserviceInventory.getapprove($scope.model.AssetID, $scope.model.ReasonStatus, function (rs) {rs=rs.data;
                if (rs.Error) {
                    App.toastrError(rs.Title);
                } else {
    ...
    $scope.viewActivityStatus = function () {
        dataserviceInventory.getActivityStatus($scope.model.AssetID, function (rs) {rs=rs.data;
            if (rs.Error) {
                App.toastrError(rs.Title);
            } else {
                var modalInstance = $uibModal.open({
...
app.controller('file_add_old', function ($scope, $rootScope, $compile, $uibModal, $confirm, dataserviceInventory, $uibModalInstance) {
    ...
    $scope.initData = function () {
        ...
        //});
        dataserviceInventory.GenReqfile(function (rs) {rs=rs.data;
    ...
    $scope.submit = function () {
        if ($scope.addformfile.validate()) {
            ...
            if (file == null || file == undefined) {
                ...
                dataserviceInventory.insertFile(formData, function (result) {result=result.data;
                    if (result.Error) {
                        App.toastrError(result.Title);
                    } else {
                        App.toastrSuccess(result.Title);
...
app.controller('resultActivity', function ($scope, $rootScope, $uibModalInstance, $compile, $uibModal, DTOptionsBuilder, DTColumnBuilder, DTInstances, dataserviceInventory, $filter) {
    ...
    $scope.initLoad = function () {
        ...
        dataserviceInventory.getItemAttrSetup(obj, function (rs) {rs=rs.data;
        ...
        //});
        dataserviceInventory.getListActivityAttrData($scope.model.ObjCode, $scope.model.ActCode, $scope.model.WorkFlowCode, function (rs) {rs=rs.data;
    ...
    $scope.submit = function () {
        ...
        if ($scope.resultActivity.validate() && !validationSelect($scope.model).Status) {
            ...
            dataserviceInventory.insertAttrData($scope.model, function (result) {result=result.data;
                if (result.Error) {
                    App.toastrError(result.Title);
                } else {
                    App.toastrSuccess(result.Title);
    ...
    $scope.delete = function (id) {
        dataserviceInventory.deleteAttrData(id, function (result) {result=result.data;
            if (result.Error) {
                App.toastrError(result.Title);
            } else {
                App.toastrSuccess(result.Title);
...
app.controller('tableActivity', function ($scope, $rootScope, $compile, $uibModal, $uibModalInstance, DTOptionsBuilder, DTColumnBuilder, DTInstances, dataserviceInventory, $filter) {
    ...
    $scope.edit = function (id) {
        dataserviceInventory.getItemInventory(id, function (rs) {rs=rs.data;
    ...
    $scope.delete = function (id) {
        ...
        var modalInstance = $uibModal.open({
            ...
            controller: function ($scope, $uibModalInstance, para) {
                $scope.message = caption.COM_MSG_DELETE_CONFIRM_COM;
                $scope.ok = function () {
                    dataserviceInventory.deleteItemActivity(para, function (rs) {rs=rs.data;
                        if (rs.Error) {
                            App.toastrError(rs.Title);
                        } else {
                            App.toastrSuccess(rs.Title);
...
app.controller('fileAsset', function ($scope, $rootScope, $compile, $uibModal, DTOptionsBuilder, DTColumnBuilder, DTInstances, dataserviceInventory, $filter) {
    var vm = $scope;
    $scope.selected = [];
    $scope.selectAll = false;
    $scope.toggleAll = toggleAll;
...
app.controller('tabFileHistory', function ($scope, $rootScope, $compile, $uibModal, $uibModalInstance, DTOptionsBuilder, DTColumnBuilder, DTInstances, dataserviceInventory, $filter, para) {
    ...
    $scope.getObjectFile = function (id) {
        dataserviceInventory.getItemFile(id);
    };

var ctxfolder = "/views/admin/vcStaffPosition";
...
app.factory('dataservice', function ($http) {
    ...
    return {
        ...
        GetListStaff: function (callback) {
            $http.post('/Admin/VCStaffPosition/GetListStaff').success(callback);
        },
        getStaffCheckIn: function (data, callback) {
            $http.post('/Admin/VCStaffPosition/getStaffCheckIn/', data).success(callback);
        },
        getStaffCheckInNotPaging: function (data, callback) {
            $http.post('/Admin/VCStaffPosition/GetStaffCheckInNotPaging/', data).success(callback);
        },

        
        //getStaffCheckIn1: function (data, callback) {
        //    $http.post('/Admin/VCStaffPosition/getStaffCheckIn1/', data).success(callback);
        //},
...
app.controller('index', function ($scope, $rootScope, $confirm, $compile, $uibModal, DTOptionsBuilder, DTColumnBuilder, DTInstances, dataservice, $http) {
    ...
    function reloadNotPaging() {
        ...
        dataservice.getStaffCheckInNotPaging(searchData, function (rs) {
    ...
    $scope.init = function () {
        ...
        dataservice.GetListStaff(function (rs) {
            $scope.Customers = rs;
        });
    ...
    $scope.searchMap = function () {
        ...
        if (place == undefined) {
            App.toastrError(caption.VCSP_VALIDATE_ENTER_ADDRESS);   //Vui lòng nhập địa chỉ chính xác!
            return;
        }

...
var app = angular.module('App_ESEIM_CANCLE', ["ui.bootstrap", "ngRoute", "ngValidate", "datatables", "datatables.bootstrap", 'datatables.colvis', "ui.bootstrap.contextMenu", 'datatables.colreorder', 'angular-confirm', "ngJsTree", "treeGrid", "ui.select", "ngCookies", "pascalprecht.translate", 'dynamicNumber', 'ngTagsInput']).
...
app.controller('Ctrl_ESEIM_CANCLE', function ($scope, $rootScope, $compile, $uibModal, dataserviceCancle, $cookies, $translate) {
    ...
    //    $rootScope.Status = rs;
    //})
    dataserviceCancle.GetStatus(function (result) {result=result.data;
        $rootScope.ListStatus = result;
    });
    dataserviceCancle.getCatActivity(function (rs) {rs=rs.data;
...
app.controller('AssetCancel', function ($scope, $rootScope, $confirm, $compile, $uibModal, DTOptionsBuilder, DTColumnBuilder, DTInstances, dataserviceCancle, $filter, $translate) {
    var vm = $scope;
    ...
    vm.dtColumns.push(DTColumnBuilder.newColumn('Status').withTitle('{{ "ASSET_CANCEL_TICKET_STATUS" | translate }}').renderWith(function (data, type) {
        return data;
    }));
    ...
    $scope.delete = function (id) {
        var modalInstance = $uibModal.open({
            ...
            controller: function ($scope, $uibModalInstance) {
                ...
                $scope.ok = function () {
                    dataserviceCancle.Delete(id, function (rs) {rs=rs.data;
                        if (rs.Error) {
   ...
   // $scope.model.
    ...
    $scope.addasset = function () {
        ...
        if ($scope.addassetform.validate() && !validationSelect($scope.modelasset).Status) {
            ...
            dataserviceCancle.insertasset($scope.modelasset, function (result) {result=result.data;
                if (result.Error) {
    ...
    $scope.initLoad = function () {
        dataserviceCancle.GetStatusAsset(function (result) {result=result.data;
    ...
    $scope.ListAssset = [];
    $scope.initLoad = function () {
        dataserviceCancle.GetAssset(function (result) {result=result.data;
    ...
    $scope.delete = function (id) {
        var modalInstance = $uibModal.open({
            ...
            controller: function ($scope, $uibModalInstance) {
                $scope.message = caption.COM_MSG_DELETE_CONFIRM.replace('{0}', "");
                $scope.ok = function () {
                    dataserviceCancle.DeleteAsset(id, function (rs) {rs=rs.data;
                        if (rs.Error) {
                            App.toastrError(rs.Title);
                        } else {
                            App.toastrSuccess(rs.Title);
...
app.controller('index', function ($scope, $rootScope, $compile, $uibModal, DTOptionsBuilder, DTColumnBuilder, DTInstances, dataserviceCancle, $filter) {
    $scope.modelsearch = {
        Title: '',
        Person: '',
        Branch: '',
    ...
    $scope.initLoad = function () {
        ...
        dataserviceCancle.GetBranch(function (result) {result=result.data;
        ...
        dataserviceCancle.GetPerson(function (result) {result=result.data;
...
app.controller('add', function ($scope, $rootScope, $compile, $uibModal, $uibModalInstance, DTColumnBuilder, DTInstances, dataserviceCancle, $filter) {
    $scope.CheckCode = '';
    $scope.model = {
    ...
    dataserviceCancle.getCatObjActivity(function (rs) {rs=rs.data;
    ...
    $scope.submit = function () {
        ...
        if ($scope.addform.validate() && !validationSelect($scope.model).Status) {
            ...
            if (!$rootScope.IsAdd) {
                dataserviceCancle.insert($scope.model, function (result) {result=result.data;
                    if (result.Error) {
                        App.toastrError(result.Title);
                    } else {
                        App.toastrSuccess(result.Title);
                ...
                dataserviceCancle.updateCancle($scope.model, function (rs) {rs=rs.data;
                    if (rs.Error) {
                        App.toastrError(rs.Title);
                    } else {
                        App.toastrSuccess(rs.Title);
    ...
    $scope.addFile = function () {
        if ($rootScope.IsAdd == true) {
            ...
            modalInstance.result.then(function (d) {
                dataserviceCancle.GetListFile($rootScope.TicketCode, function (rs) {rs=rs.data;
    ...
    $scope.deleteFile = function (id) {
        dataserviceCancle.DeleteFile(id, function (result) {result=result.data;
            if (result.Error) {
                App.toastrError(result.Title);
            } else {
                App.toastrSuccess(result.Title);
                dataserviceCancle.GetListFile($scope.model.TicketCode, function (rs) {rs=rs.data;
                    $scope.model.listFile = rs;
                });
            }
        });
    ...
    dataserviceCancle.GetGenReqCode(function (rs) {rs=rs.data;
        if (!rs.Error) {
    ...
    $scope.changleSelect = function (SelectType) {
        ...
        if (SelectType == "ActCode" && $scope.model.ActCode != "") {
            dataserviceCancle.InsertAct($scope.model, function (result) {result=result.data;
                if (result.Error) {
                    App.toastrError(result.Title);
                } else {
                    App.toastrSuccess(result.Title);
...
app.controller('editCancle', function ($scope, $rootScope, $compile, $uibModal, $uibModalInstance, dataserviceCancle, $filter, para) {
    ...
    $scope.changleSelect = function (SelectType) {
        ...
        if (SelectType == "ActCode" && $scope.model.ActCode != "") {
            ...
            dataserviceCancle.insertLogData($scope.model, function (result) {result=result.data;
                if (result.Error) {
                    App.toastrError(result.Title);
                } else {
                    App.toastrSuccess(result.Title);
    ...
    $scope.pending = function () {
        dataserviceCancle.getpending($scope.model.AssetID, function (rs) {rs=rs.data;
            if (rs.Error) {
                App.toastrError(rs.Title);
            } else {
    ...
    $scope.reject = function () {
        var modalInstance = $uibModal.open({
            animation: true,
            templateUrl: ctxfolderCancle + '/reasonReject.html',
        ...
        modalInstance.result.then(function (d) {
            ...
            dataserviceCancle.getreject($scope.model.AssetID, $scope.model.ReasonStatus, function (rs) {rs=rs.data;
                if (rs.Error) {
                    App.toastrError(rs.Title);
                } else {
    ...
    $scope.approve = function () {
        ...
        modalInstance.result.then(function (d) {
            ...
            if ($scope.model.ReasonStatus == null || $scope.model.ReasonStatus == undefined)
                $scope.model.ReasonStatus = '';
            dataserviceCancle.getapprove($scope.model.AssetID, $scope.model.ReasonStatus, function (rs) {rs=rs.data;
                if (rs.Error) {
                    App.toastrError(rs.Title);
                } else {
    ...
    $scope.viewActivityStatus = function () {
        dataserviceCancle.getActivityStatus($scope.model.AssetID, function (rs) {rs=rs.data;
            if (rs.Error) {
                App.toastrError(rs.Title);
            } else {
                var modalInstance = $uibModal.open({
...
app.controller('file_add_old', function ($scope, $rootScope, $compile, $uibModal, $confirm, dataserviceCancle, $uibModalInstance) {
    ...
    $scope.initData = function () {
        ...
        //});
        dataserviceCancle.GenReqfile(function (rs) {rs=rs.data;
    ...
    $scope.submit = function () {
        if ($scope.addformfile.validate()) {
            ...
            if (file == null || file == undefined) {
                ...
                dataserviceCancle.insertFile(formData, function (result) {result=result.data;
                    if (result.Error) {
                        App.toastrError(result.Title);
                    } else {
                        App.toastrSuccess(result.Title);
...
app.controller('resultActivity', function ($scope, $rootScope, $uibModalInstance, $compile, $uibModal, DTOptionsBuilder, DTColumnBuilder, DTInstances, dataserviceCancle, $filter) {
    ...
    $scope.initLoad = function () {
        ...
        dataserviceCancle.getItemAttrSetup(obj, function (rs) {rs=rs.data;
            $scope.model.listAttrData = rs;
        });
        dataserviceCancle.getListActivityAttrData($scope.model.ObjCode, $scope.model.ActCode, $scope.model.WorkFlowCode, function (rs) {rs=rs.data;
    ...
    $scope.submit = function () {
        ...
        if ($scope.resultActivity.validate() && !validationSelect($scope.model).Status) {
            ...
            dataserviceCancle.insertAttrData($scope.model, function (result) {result=result.data;
                if (result.Error) {
                    App.toastrError(result.Title);
                } else {
                    App.toastrSuccess(result.Title);
    ...
    $scope.delete = function (id) {
        dataserviceCancle.deleteAttrData(id, function (result) {result=result.data;
            if (result.Error) {
                App.toastrError(result.Title);
            } else {
                App.toastrSuccess(result.Title);
...
app.controller('tableActivity', function ($scope, $rootScope, $compile, $uibModal, $uibModalInstance, DTOptionsBuilder, DTColumnBuilder, DTInstances, dataserviceCancle, $filter) {
    ...
    $scope.edit = function (id) {
        dataserviceCancle.getItemCancle(id, function (rs) {rs=rs.data;
    ...
    $scope.delete = function (id) {
        ...
        var modalInstance = $uibModal.open({
            ...
            controller: function ($scope, $uibModalInstance, para) {
                $scope.message = caption.COM_MSG_DELETE_CONFIRM_COM;
                $scope.ok = function () {
                    dataserviceCancle.deleteItemActivity(para, function (rs) {rs=rs.data;
                        if (rs.Error) {
                            App.toastrError(rs.Title);
                        } else {
                            App.toastrSuccess(rs.Title);
...
app.controller('fileAsset', function ($scope, $rootScope, $compile, $uibModal, DTOptionsBuilder, DTColumnBuilder, DTInstances, dataserviceCancle, $filter) {
    var vm = $scope;
    $scope.selected = [];
    $scope.selectAll = false;
    $scope.toggleAll = toggleAll;
...
app.controller('tabFileHistory', function ($scope, $rootScope, $compile, $uibModal, $uibModalInstance, DTOptionsBuilder, DTColumnBuilder, DTInstances, dataserviceCancle, $filter, para) {
    ...
    $scope.getObjectFile = function (id) {
        dataserviceCancle.getItemFile(id);
    };

...
app.factory('dataservice', function ($http) {
    ...
    return {
        ...
        getUser: function (callback) {
            $http.post('/Admin/UrencoAssetsCategory/GetUser').then(callback);
        },
        //getAsset: function (callback) {
        //    $http.post('/Admin/UrencoAssetsCategory/GetAsset/').then(callback);
        //},
        getGetCatCode: function (callback) {
            $http.post('/Admin/UrencoAssetsCategory/GetCatCode').then(callback);
        },
        getCatParent: function (callback) {
            $http.post('/Admin/UrencoAssetsCategory/GetCatParent/').then(callback);
        },
        getCatFund: function (callback) {
            $http.post('/Admin/UrencoAssetsCategory/GetCatFund/').then(callback);
        },
        getItem: function (data, callback) {
            $http.post('/Admin/UrencoAssetsCategory/GetItem/', data).then(callback);
        },
        insert: function (data, callback) {
            $http.post('/Admin/UrencoAssetsCategory/Insert/', data).then(callback);
        },
        update: function (data, callback) {
            $http.post('/Admin/UrencoAssetsCategory/Update/', data).then(callback);
        },
        delete: function (data, callback) {
            $http.post('/Admin/UrencoAssetsCategory/Delete/' + data).then(callback);
        },
        getProceduce: function (callback) {
            $http.get('/Admin/UrencoAssetsCategory/RunProceduce').then(callback);
        },
        gettreedata: function (data, callback) {
            $http.post('/Admin/UrencoAssetsCategory/GetTreeData', data).then(callback);
        },

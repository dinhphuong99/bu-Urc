var ctxfolder = "/views/admin/vcLastConsump";
...
app.factory('dataservice', function ($http) {
    ...
    return {
        ...
        //    $http.post('/Admin/VCLastConsump/Insert', data, callback).success(callback);
        //},
        //update: function (data, callback) {
        //    $http.post('/Admin/VCLastConsump/Update', data).success(callback);
        //},
        //deleteItems: function (data, callback) {
        //    $http.post('/Admin/VCLastConsump/DeleteItems', data).success(callback);
        //},
        //delete: function (data, callback) {
        //    $http.post('/Admin/VCLastConsump/Delete/' + data).success(callback);
        //},
        //getItem: function (data, callback) {
        //    $http.get('/Admin/VCLastConsump/GetItem/' + data).success(callback);
        //},
        //getItemDetail: function (data, callback) {
        //    $http.get('/Admin/VCLastConsump/GetItemDetail/' + data).success(callback);
        //},
        getListArea: function (callback) {
            $http.post('/Admin/VCLastConsump/GetListArea/').success(callback);
        },
        getListProduct: function (callback) {
            $http.post('/Admin/VCLastConsump/GetListProduct/').success(callback);
        },
        getListBrand: function (callback) {
            $http.post('/Admin/VCLastConsump/GetListBrand/').success(callback);
        },
        getTotal: function (data, callback) {
            $http.post('/Admin/VCLastConsump/GetTotal', data).success(callback);
        },
        getAllStaff: function (callback) {
            $http.post('/Admin/VCLastConsump/GetAllStaff/').success(callback);
        },
        getListCustomer: function (callback) {
            $http.post('/Admin/VCLastConsump/GetListCustomer/').success(callback);
        },
        //gettreedataLevel: function (callback) {
        //    $http.post('/Admin/VCLastConsump/GetProductUnit/').success(callback);
        //},
        //uploadImage: function (data, callback) {
        //    submitFormUpload('/Admin/VCLastConsump/UploadImage/', data, callback);
        //}
    }
});
...
app.controller('index', function ($scope, $rootScope, $confirm, $compile, $uibModal, DTOptionsBuilder, DTColumnBuilder, DTInstances, dataservice, $http, $filter) {
    ...
    vm.dtOptions = DTOptionsBuilder.newOptions()
        .withOption('ajax', {
            url: "/Admin/VCLastConsump/Jtable",
    ...
    vm.dtColumns.push(DTColumnBuilder.newColumn('_STT').withTitle('{{"VCLC_LIST_COL_ORDER" | translate }}').notSortable().withOption('sWidth', '30px').withOption('sClass', 'tcenter').renderWith(function (data, type) {
        return data;
    }));
    ...
    vm.dtColumns.push(DTColumnBuilder.newColumn('CusName').withTitle('{{"VCLC_LIST_COL_DISTRIBUTOR_AGENCY_STORE" | translate }}').notSortable().withOption('sClass', 'tcenter').renderWith(function (data, type) {
        return data;
    }));
    vm.dtColumns.push(DTColumnBuilder.newColumn('AreaName').withTitle('{{"VCLC_LIST_COL_AREA" | translate }}').notSortable().renderWith(function (data, type) {
        return data;
    }));
    ...
    //        return '';
    //}));
    vm.dtColumns.push(DTColumnBuilder.newColumn('ProductName').withTitle('{{"VCLC_LIST_COL_CLASSIFY" | translate }}').notSortable().withOption('sClass', 'tcenter').renderWith(function (data, type) {
        return data;
    }));
    vm.dtColumns.push(DTColumnBuilder.newColumn('BrandName').withTitle('{{"VCLC_LIST_COL_TRADEMARK" | translate }}').notSortable().withOption('sClass', 'tcenter').renderWith(function (data, type) {
        return data;
    }));
    vm.dtColumns.push(DTColumnBuilder.newColumn('ConsumpMonthly').withTitle('{{"VCLC_LIST_COL_PRODUCTION_CONSUMPTION_MONTH" | translate}}').notSortable().withOption('sClass', 'tcenter').renderWith(function (data, type) {
    ...
    //    return '<span class="bold"> ' + dataFormat + '</span>';
    //}));
    vm.dtColumns.push(DTColumnBuilder.newColumn('Staff').withTitle('{{"VCLC_LIST_COL_EMPLOYEES" | translate }}').notSortable().withOption('sClass', 'tcenter').notSortable().renderWith(function (data, type) {
        return data;
    }));
    vm.dtColumns.push(DTColumnBuilder.newColumn('CreatedTime').withTitle('{{"VCLC_LIST_COL_TIME" | translate }}').notSortable().withOption('sClass', 'tcenter').renderWith(function (data, type) {
        if (data != null && data != '')
    ...
    $scope.getTotalValue = function () {
        dataservice.getTotal($scope.model, function (result) {
            if (result.Error) {
                ...
                $scope.totalConsumpMonthly = result.totalConsumpMonthly;
            }
        });
    };
    ...
    $scope.export = function () {
        ...
        location.href = "/Admin/VCLastConsump/ExportExcel?"
            + "page=" + page
            + "&row=" + length

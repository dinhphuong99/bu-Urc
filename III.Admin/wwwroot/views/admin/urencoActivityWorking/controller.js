var ctxfolder = "/views/admin/UrencoActivityWorking";
var ctxfolderCommonSetting = "/views/admin/UrencoActivityWorking";
...
app.factory('dataservice', function ($http) {
    ...
    return {
        insert: function (data, callback) {
            $http.post('/Admin/UrencoActivityWorking/Insert', data).then(callback);
            //submitFormUpload1('/Admin/HREmployee/Insert', data, callback);
        },
        update: function (data, callback) {
            $http.post('/Admin/UrencoActivityWorking/Update', data).then(callback);
        ...
        delete: function (data, callback) {
            $http.post('/Admin/UrencoActivityWorking/Delete?id=' + data).then(callback);
        },
        getItem: function (data, callback) {
            $http.get('/Admin/UrencoActivityWorking/GetItem?id=' + data).then(callback);
        },
...
app.config(function ($routeProvider, $validatorProvider, $translateProvider, $httpProvider) {
    ...
    $translateProvider.useUrlLoader('/Admin/UrencoActivityWorking/Translation');
...
app.controller('index', function ($scope, $rootScope, $compile, $uibModal, DTOptionsBuilder, DTColumnBuilder, DTInstances, $translate, $window, dataservice) {
    ...
    vm.dtOptions = DTOptionsBuilder.newOptions()
        .withOption('ajax', {
            url: "/Admin/UrencoActivityWorking/jtable",
    ...
    vm.dtColumns.push(DTColumnBuilder.newColumn('ActName').withTitle('Tên hoạt động').renderWith(function (data, type) {
        return data;
    }).withOption('sClass', 'dataTable-pr0  dataTable-20per'));
...
app.controller('add', function ($scope, $rootScope, $compile, $uibModal, $uibModalInstance, dataservice, DTOptionsBuilder, DTColumnBuilder, DTInstances, $filter, $translate, para) {
    ...
    $scope.initData = function () {
        ...
        dataservice.getTypeCar(function (rs) {rs=rs.data;
            debugger
            console.log(rs);
            $scope.types = rs;
        })

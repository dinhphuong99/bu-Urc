function CGame(oData){
    ...
    this.spinWheel = function(){
        ...
        //SELECT PRIZE   
        var iWin = Math.random()*100;

        if(iWin < WIN_OCCURRENCE){
            //WIN CASE
            do{
                ...
                var iTotMoneyWin = WHEEL_SETTINGS[_iCurWin].prize * _iMultiply;

            } while(iTotMoneyWin < _iCurBet);
    ...
    this.onExit = function(){
        ...
        var szMsg = "You collected <strong>" + (_iCurCredit) + " points</strong>!<br><br>Share your score with your friends!";
        var szMsgShare = "My score is " + (_iCurCredit) + " points! Can you do better";
        
        $(s_oMain).trigger("share_event",[_iCurCredit, szImage, szTitle, szMsg, szMsgShare]);

...
fm.websync.chat.clientExtensions = (function() {
  ...
  clientExtensions.getUserId = function() {
    var _var0, channel, recordValueJson, records;
    records = arguments[0];
    channel = arguments[1];
  ...
  clientExtensions.getUserIdFromArray = function() {
    var _var0, channel, recordValueJsonFromArray, records;
    records = arguments[0];
    channel = arguments[1];
  ...
  clientExtensions.onReceive = function() {
    var _var0, _var1, _var2, _var3, _var4, _var5, args, args4, dictionary, dictionary2, dynamicValue, obj2, p, user;
    args = arguments[0];
    dynamicValue = args.getDynamicValue(fm.websync.chat.clientExtensions._argsKey);
  ...
  clientExtensions.onSubscribeSuccess = function() {
    var _var0, _var1, _var2, args, client, clientArray, dictionary, dynamicValue, i, j, len, len1, state, user, users;
    args = arguments[0];
    dynamicValue = args.getDynamicValue(fm.websync.chat.clientExtensions._argsKey);
    state = dynamicValue.getDynamicValue(fm.websync.chat.clientExtensions._joinStateKey);
    dynamicValue.unsetDynamicValue(fm.websync.chat.clientExtensions._joinStateKey);
    ...
    if (!state.getBindSuccess()) {
      ...
      for (j = 0, len1 = _var2.length; j < len1; j++) {
        user = _var2[j];
  ...
  clientExtensions.process = function() {
    var _var0, _var1, _var10, _var2, _var3, _var4, _var5, _var6, _var7, _var8, _var9, args2, args3, args4, args5, args6, args7, args8, channel, dictionary2, dynamicValue, fireEvents, flag, flag2, joinArgs, obj2, onUserClientJoin, onUserClientLeave, onUserJoin, onUserLeave, outputArgs, p, subscriber, type, user;
    type = arguments[0];
  ...
  clientExtensions.raiseJoinFailure = function() {
    var _var0, _var1, args, args3, args4, args5, channels, error, error1, exception, exception1, exception2, exception3, isRejoin, joinArgs, onComplete, onFailure, p, retry;
  ...
  clientExtensions.raiseJoinSuccess = function() {
    var _var0, _var1, args, args3, args4, args5, error, error1, exception, exception1, exception2, joinArgs, onComplete, onSuccess, p, users;
    joinArgs = arguments[0];
    args = arguments[1];
    users = arguments[2];
  ...
  clientExtensions.raiseLeaveFailure = function() {
    var _var0, _var1, args, args3, args4, args5, channels, error, error1, exception, exception1, exception2, exception3, leaveArgs, onComplete, onFailure, p, retry;
  ...
  clientExtensions.raiseLeaveSuccess = function() {
    var _var0, _var1, args, args3, args4, args5, error, error1, exception, exception1, exception2, leaveArgs, onComplete, onSuccess, p;
    leaveArgs = arguments[0];
    args = arguments[1];
